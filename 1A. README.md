...
Add explanation (Pranshu)

The App windows were created using a class setup. A class was created for each window in the Python file and a main app class was created with reference to the Kivy Design file for the GUI.  
...
A sample for a screen page design is shown below: 
...
Pranshu (Add Explanation). BTW, all the results were saved in a global list to be outputed by the functions
